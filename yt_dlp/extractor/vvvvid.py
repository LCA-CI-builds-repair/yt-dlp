...
class VVVVIDIE(InfoExtractor):
    ...
    _blocked_user_agents_regex = r'^Mozilla/5\.0 \(Windows NT 10\.0; Win64; x64\) AppleWebKit/537\.36 \(KHTML, like Gecko\) Chrome/[\d.]+(?:\s|$)'
    _headers = {}
    ...
    def _get_headers(self):
        ...
        if not user_agent or re.search(self._blocked_user_agents_regex, user_agent):
