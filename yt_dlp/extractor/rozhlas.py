...
from ..utils import (
    ExtractorError,
    extract_attributes,
                   'channe        }                                  'description': 'title',
                'duration': int_or_none,    'id': audio_id,
            'chapter': traverse_obj(entry, ('meta', 'ga', 'contentNameShort')) if chapter_number else None  'channel_id': 'dvojka',
            }        'playlist_count': 1id': 'radio-wave',
            },
        }, {
