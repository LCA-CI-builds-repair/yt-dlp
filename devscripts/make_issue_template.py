#!/usr/bin/env pyth  - type: checkboxes
 '''
...
'''.strip()
    attributes:
      ...
      options:
        - label: Run **your** yt-dlp command with `-vU` flag added (e.g., `yt-dlp -vU <your command line>`)
          required: true
  ...
  - type: textarea
    ...
    attributes:
      ...
      description: |
        It should start like this: `[debug] Command-line config ...`ct execution
import os
import sys
